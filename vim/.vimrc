...
set laststatus=1    " 启动显示状态行(1),总是显示状态行(2)  set foldenable      " 允许折叠  
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "\# Author: narutolby") 
		call append(line(".")+2, "\# mail: willianlby@yahoo.cn") 
...
map <C-F5> :call CompileRunGcc1()<CR>
func! CompileRunGcc()
	exec "w"
	if &filetype == 'c'
		exec "!gcc % -o %< -lm"
